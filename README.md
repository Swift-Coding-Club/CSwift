...
* Chapter 1 : 디자인 패턴과 프로그래밍 패러다임
  - Section 1.1 : 디자인 패턴
    ...
    + 옵저버 패턴
    + 프록시 패턴과 프록시 서버
    + [이터레이터 패턴]([이터레이터](https://github.com/Swift-Coding-Club/CSwift/blob/b4daf3e0250892d07d039831b4b8ab3250a3cf1c/%EC%9D%B4%ED%84%B0%EB%A0%88%EC%9D%B4%ED%84%B0%20%ED%8C%A8%ED%84%B4))
    + 노출모듈 패턴
    + MVC 패턴
    + MVVM 패턴
